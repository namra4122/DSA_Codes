    ...
    public static void main(String[] args) {
        ...
        for (int z = 1; z <= cases; z++) {
            ...
            for (int x = num.length() - 1; x >= 0; x--) {
                System.out.println("map value: " + map1.get(num.substring(x, x + 1)));
                System.out.println("POW VALUE: " + Math.pow(base1, num.length() - x - 1));

                base10Num = base10Num
                        + map1.get(num.substring(x, x + 1)) * (long) Math.pow(base1, num.length() - x - 1);
            }
